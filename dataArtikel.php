...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link  active" href="dataArtikel.php"><i class="fas fa-table"></i><span>Artikel</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Data Artikel</h3>
                    
                    <div class="container">
                        <button class='btn btn-sm btn-warning' data-bs-toggle="modal" data-bs-target="#modalTambah" style="margin-bottom: 20px; color: white">
                        <i class="fas fa-user"></i> Tambah Artikel</button>

                        <a href="exportDataArtikel.php" class='btn btn-sm btn-success' style="margin-bottom: 20px; color: white">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modal-title">Tambah Artikel</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="nama" class="form-label">Kode Artikel</label>
                                            <input type="text" class="form-control" name="kode_artikel">

                                            <label for="teks" class="form-label">Teks</label>
                                            <textarea class="form-control" name="teks"></textarea>
                                        </div>
    ...
    <script src="app artikel.js"></script>
