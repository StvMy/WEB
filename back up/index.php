...
<body>
  ...
  <?php 
    function artikel_nomor($brp){
      ...
      $sql = "SELECT teks FROM artikel where kode_artikel=$brp";
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="viewProduct.html">Products</a></li>
    ...
    <div class="container">
      <div class="head">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <img src="assets/img/Heli.png"  alt="" width="1120px" >
          <div class="text-block">
            <div class="text">
              <h1 style="color: white;">AIRBUS</h1>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/EXPH.png" class="img-fluid" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-plane">
            <img src="assets/img/pesawat/A330-200F.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>A330-200F</h4>
              <p>App</p>
              <a href="assets/img/pesawat/A330-200F.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              ...
              <a href="A330-details.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-jet">
            <img src="assets/img/pesawat/Eurofighter.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Eurofighter</h4>
              <p>Web</p>
              <a href="assets/img/pesawat/Eurofighter.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              ...
              <a href="Eurofighters-details.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-plane">
            <img src="assets/img/pesawat/BelugaXL.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Beluga XL</h4>
              <p>App</p>
              <a href="assets/img/pesawat/BelugaXL.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              ...
              <a href="Beluga-XL-details.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-helic">
            <img src="assets/img/pesawat/H225.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>H225</h4>
              <p>Card</p>
              <a href="assets/img/pesawat/H225.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              title="The H225 is the latest member of Airbus' proven Super Puma/Cougar family, which has accumulated more than 5.8 million flight hours during operations around the world in the harshest conditions – including severe icing and highly challenging maritime environments. The H225M military version also has operated in the most demanding combat SAR (CSAR) missions."><i class="bx bx-plus"></i></a>
              <a href="H225-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-jet">
            <img src="assets/img/pesawat/A330 MRTT.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>A330 MRTT</h4>
              <p>Web</p>
              <a href="assets/img/pesawat/A330 MRTT.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
              <a href="A330-MRTT-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-plane">
            <img src="assets/img/pesawat/belugast.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Beluga ST</h4>
              <p>App</p>
              <a href="assets/img/pesawat/belugast.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              ...
              <a href="Beluga-ST-details.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-helic">
            <img src="assets/img/pesawat/H215.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>H215</h4>
              <p>Card</p>
              <a href="assets/img/pesawat/H215.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              title="Airbus' H215 offers excellent payload lift performance and cost efficiency, along with a demonstrated ability to operate in the world’s harshest environments."><i class="bx bx-plus"></i></a>
              <a href="H215-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-helic">
            <img src="assets/img/pesawat/H130.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>H130</h4>
              <p>Card</p>
              <a href="assets/img/pesawat/H130.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" 
              title="The H130 is an intermediate single-engine helicopter tailored for passenger transport, sightseeing and VIP duties, as well as medical airlift and surveillance missions. As a multi-role rotorcraft, the H130 has a spacious cabin for one pilot and up to seven passengers. Depending on the configuration, it can carry up to two pilots, one stretcher and three-to-four medical crew.

              Other H130 enhancements include an active vibration control system and advanced environmental control; improved air conditioning; a cabin interior structure redesign with a full flat floor; a cockpit update for an enhanced human-machine interface integrating a glass cockpit Garmin G500H with synthetic vision system (SVS) and helicopter terrain avoidance and warning system (HTAWS); energy-absorbing seats and integration of a crash-resistant fuel system."><i class="bx bx-plus"></i></a>
              <a href="H130-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/team/team-2.jpg" alt="" width="200px">
              <h4>Steven Nata</h4>
