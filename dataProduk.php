            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <i class="fas fa-user"></i> Tambah Produk</button>

                        <a href="exportDataProduk.php" class='btn btn-sm btn-success' style="margin-bottom: 20px; color: white">
                        <i class="fas fa-download"></i> Export</a>

                        <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="pdfProduk.php" style="margin-bottom: 20px; color: white"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Export As PDF</a>
